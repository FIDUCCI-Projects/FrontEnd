            ...
            <nav className="border-b border-white/5 bg-[rgba(15,16,21,0.7)] backdrop-blur-[32px] px-6 py-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        <Link href="/dashboard" className="text-sm text-text-secondary hover:text-white transition-colors">
                            Dashboard
                        </Link>
                        <Link href="/dapp/projects" className="text-sm text-text-secondary hover:text-white transition-colors">
                            Marketplace
                        </Link>
